def usuario_escolhe_jogada (n, m):    
    ...
    #além dos parametros que traz valores externos, é necessario essa variável para dentro dessa função.
    if a <= m and a > 0 and a <= n:        
        return (a)
    else:
        ...
        while a > m or a <= 0 or a > n:
            ...
            if (a > m or a <= 0) or a > n:
                print("O valor digitado é inválido, tente novamente!")
        return (a)
    #A função solicita ao usuário a quantidade de palitos a serem tirados e retorna esse valor.
    #Fazer um laço para dizeer que o valor é inválido
